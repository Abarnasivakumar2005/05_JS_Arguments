...
var player1 = {
    ...
    health: 50,
    healthMultiplier: 1.2 // Adding healthMultiplier
};
...
var player2 = {
    ...
    health: 40,
    healthMultiplier: 1.5 // Adding healthMultiplier
};

var showPlayerHealth;

showPlayerHealth = function (playerName, playerHealth, playerHealthMultiplier) {
    var effectiveHealth = playerHealth * playerHealthMultiplier; // Calculate effective health
    console.log(playerName + " has health " + effectiveHealth);
};

// Call the function with player objects
